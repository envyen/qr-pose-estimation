...
*/
SOMScopeGuard::SOMScopeGuard(std::function<void()> inputFunction)
		: functionToCall(inputFunction) {
	scopeGuardHasBeenDismissed = false;
}

/*
This function tells the scope guard that it should not call the function it was
given when it goes out of scope.
*/
...
/*
This destructor cleans up the object and calls the function that it was given on
its creation.
*/
